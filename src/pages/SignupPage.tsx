    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen">
        <div className="container mx-auto px-4">
          <motion.div
            className="max-w-md mx-auto bg-dark-surface border border-dark-border rounded-lg overflow-hidden shadow-xl"
            ...
            <div className="p-8">
              <div className="text-center mb-8">
                <GlitchText
                  text="CREATE ACCOUNT"
                  as="h1"
                  className="font-sans text-3xl font-extrabold text-white tracking-wider" // Increased size, weight, and spacing
                />
                <p className="text-gray-400 mt-2">
                  Join our network of underground techno artists
                </p>
              </div>
              ...
              <p className="text-center text-sm text-gray-400">
                <strong>We recommend signing up with Google</strong> for the best experience and to easily contact us.
              </p>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-dark-bg border border-dark-border text-white rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-neon-cyan focus:border-transparent transition-all"
              ...
              <div className="mt-8 text-center text-sm text-gray-400">
                ...
                <Link to="/login" className="text-neon-cyan font-medium hover:text-neon-cyan/80">
                  Login here
                </Link>
              </div>
            </div>
